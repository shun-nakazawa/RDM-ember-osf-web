...
export default class MetaTags extends Service {
    ...
    getMetaTags(metaTagsOverrides: MetaTagsData): MetaTagsDefs {
        ...
        const metaTagsData: MetaTagsData = {
            ...
            imageWidth: 1200,
            imageHeight: 630,
            imageAlt: this.intl.t('home.brand', { brand: this.brand }),
            siteName: this.intl.t('home.brand', { brand: this.brand }),
            institution: this.intl.t('general.cos', { organization: this.organization }),
